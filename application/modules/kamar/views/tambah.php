                   ...
                   <div class="col-md-8">
                       <form method="POST" enctype="multipart/form-data">
                        <div class="form-group <?php if(form_error('id_kamar')) echo 'has-error'?>">
                          ...
                          <input readonly="" type="text" id="id_kamar" name="id_kamar" class="form-control id_kamar " placeholder="ID kamar" value="<?php echo autoID('KMR', 'kamar') ?>">
                          <?php echo form_error('id_kamar', '<small style="color:red">','</small>') ?>
                           ...
                           <div class="form-group <?php if(form_error('nama_kamar')) echo 'has-error'?>">
                               ...
                               <input type="text" id="nama_kamar" name="nama_kamar" class="form-control nama_kamar" placeholder="Nama kamar" value="<?php echo set_value('nama_kamar') ?>">
                           ...
                           <div class="form-group <?php if(form_error('harga')) echo 'has-error'?>">
                             ...
                             <input type="text" id="harga" name="harga" class="form-control harga " placeholder="Harga" value="<?php echo set_value('harga') ?>">
