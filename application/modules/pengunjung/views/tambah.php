                   ...
                   <div class="col-md-8">
                       <form method="POST" enctype="multipart/form-data">
                          <div class="form-group <?php if(form_error('tgl_pengunjung')) echo 'has-error'?>">
                            ...
                            <input type="date" id="tgl_pengunjung" name="tgl_pengunjung" class="form-control tgl_pengunjung " placeholder="Tanggal Pengunjung" value="<?php echo set_value('tgl_pengunjung') ?>">
                          ...
                          <div class="form-group <?php if(form_error('nama_lembaga')) echo 'has-error'?>">
                            ...
                            <input type="text" id="nama_lembaga" name="nama_lembaga" class="form-control nama_lembaga " placeholder="Nama Lembaga" value="<?php echo set_value('nama_lembaga') ?>">
                           ...
                           <div class="form-group <?php if(form_error('nama_pengunjung')) echo 'has-error'?>">
                               ...
                               <input type="text" id="nama_pengunjung" name="nama_pengunjung" class="form-control nama_pengunjung" placeholder="Nama Pengunjung" value="<?php echo set_value('nama_pengunjung') ?>">
                           ...
                           <div class="form-group <?php if(form_error('no_telp')) echo 'has-error'?>">
                             ...
                             <input type="text" id="no_telp" name="no_telp" class="form-control no_telp " placeholder="No Telepon" value="<?php echo set_value('no_telp') ?>">
                           ...
                           <div class="form-group <?php if(form_error('no_fax')) echo 'has-error'?>">
                             ...
                             <input type="text" id="no_fax" name="no_fax" class="form-control no_fax " placeholder="No Fax" value="<?php echo set_value('no_fax') ?>">
                             <?php echo form_error('no_fax', '<small style="color:red">','</small>') ?>
                           </div>
                           <div class="form-group <?php if(form_error('no_hp')) echo 'has-error'?>">
                             <label for="no_hp">No HP</label>
                             <input type="text" id="no_hp" name="no_hp" class="form-control no_hp " placeholder="No HP" value="<?php echo set_value('no_hp') ?>">
                             <?php echo form_error('no_hp', '<small style="color:red">','</small>') ?>
                           </div>
                           <div class="form-group <?php if(form_error('email')) echo 'has-error'?>">
                             <label for="email">E-mail</label>
                             <input type="email" id="email" name="email" class="form-control email " placeholder="E-mail" value="<?php echo set_value('email') ?>">
